<nav class = "flex-col md:flex-row  bg-orange-400 w-full min-h-[10vh]">
    <!-- Primary Navigation Menu -->

    <div class="flex flex-col  md:flex-row md:min-h-fit   bg-red-300    w-full">
        <!-- Logo -->
        <div class="  w-[75px] ">
        ...
        {{-- nav options --}}
        <div class="  mx-auto md:static  md:min-h-fit bg-fuchsia-950 ">
            <ul class=" nav-links  md:flex     md:items-center md:gap-[4vw]  text-black bg-green-500">
