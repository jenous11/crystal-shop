...
<div
    class="group w-full max-w-[320px] overflow-hidden rounded-[26px] border border-[#dce4d9] bg-white shadow-[rgba(0,0,0,0.1)_0px_2px_4px_0px] transition duration-300 hover:-translate-y-1 hover:shadow-[rgba(0,0,0,0.1)_4px_4px_8px_2px]">
    ...
    <a href="{{ route('products.show', $product->id) }}" class="block overflow-hidden">
        ...
        <img
            ...
            alt="product image"
            class="h-[200px] w-full object-cover transition duration-500 group-hover:scale-[1.04]"
        >
